...
def get_sentence_word_frequency(sentence: str) -> float:
    ...
    #
    freqs = [wordfreq.zipf_frequency(word, SOURCE_LANGUAGE) for word in words]
...
if __name__ == "__main__":
    ...
    audio_downloader = AudioDownloader(
        SOURCE_LANGUAGE, SENTENCES_WITH_AUDIO_PATH, audio_dir=AUDIO_DIR
    )
